...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setChartData({
          dates: reversedData.map((item) => item.activity_date),
  ...
  return (
    <>
      <PageMeta
        title="Dashboard | Stress Prediction System"
        description="Dashboard mahasiswa untuk sistem prediksi stress"
      />
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-gray-200 bg-gradient-to-r from-brand-500 to-brand-600 p-6 dark:border-gray-800">
          ...
          <p className="text-brand-100">
            Pantau kesehatan mental Anda dengan mencatat aktivitas harian dan mengisi kuesioner PSS-10.
          </p>
        </div>

        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Digital Activity Count */}
          <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Aktivitas Digital</p>
                <h3 className="text-2xl font-bold text-gray-800 dark:text-white mt-1">
                  {stats.digitalCount}
                </h3>
                <p className="text-xs text-gray-400 mt-1">data tercatat</p>
              </div>
          ...
          {/* Physiological Data Count */}
          <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Data Fisiologis</p>
                <h3 className="text-2xl font-bold text-gray-800 dark:text-white mt-1">
                  {stats.physioCount}
                </h3>
                <p className="text-xs text-gray-400 mt-1">data tercatat</p>
              </div>
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-success-50 dark:bg-success-500/10">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-500 dark:text-gray-400">Kuesioner PSS-10</p>
                <h3 className="text-2xl font-bold text-gray-800 dark:text-white mt-1">
                  {stats.pss10Count}
                </h3>
                <p className="text-xs text-gray-400 mt-1">kali mengisi</p>
              </div>
              <div className="flex items-center justify-center w-12 h-12 rounded-full bg-warning-50 dark:bg-warning-500/10">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                {stats.lastPSS10Score !== null && (
                  <p className="text-xs text-gray-400 mt-1">Skor: {stats.lastPSS10Score}/40</p>
                )}
              </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
          ...
          <Link
            to="/student/input"
            className="flex items-center gap-4 p-5 rounded-xl border-2 border-dashed border-brand-300 hover:border-brand-500 hover:bg-brand-50/50 transition dark:border-brand-500/50 dark:hover:border-brand-400 dark:hover:bg-brand-500/5"
          >
            <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-r from-brand-500 to-brand-600 shadow-lg">
              <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
              </svg>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Input Data Harian</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Isi data aktivitas digital, fisiologis, dan kuesioner PSS-10 dalam satu form
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Usahakan tidur 7-9 jam setiap malam untuk menjaga kesehatan mental dan fisik.
              </p>
            </div>
            <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-800/50">
